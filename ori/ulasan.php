  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708z"/>
    ...
    <tbody>
        <?php
            ...
            if (!$result) {
                echo "<tr><td colspan='5' class='cell'>Terjadi kesalahan dalam pengambilan data: " . mysqli_error($koneksi) . "</td></tr>";
            } else {
                $no = 1;
                ...
                if ($no === 1) {
                    echo "<tr><td colspan='5' class='cell'>Tidak ada ulasan yang tersedia.</td></tr>";
                }
            }
        ?>
    </tbody>
