    ...
    <div class="mb-3">
        ...
        <div class="d-flex align-items-start mb-3">
            <div class="me-4" style="flex: 1;">
                <img src="./img/<?= $row['img'] ?>" alt="Gambar Buku" style="max-width: 90%; height: auto;">
            </div>
            ...
            <div style="flex: 2;">
                ...
                <button type="submit" name="pinjam" value="submit" class="btn app-btn-primary">Pinjam</button>
            </div>
        </div>
    </div>
</form>
...
if (isset($_POST['pinjam'])) {
    ...
    // Mengambil ID user dari username
    $result_user = mysqli_query($koneksi, "SELECT id_user FROM user WHERE username = '$username'");
    $row_user = mysqli_fetch_assoc($result_user);
    $id_user = $row_user['id_user'];

    if ($id_user) {
        $sql = "INSERT INTO peminjaman VALUES (null, '$id_user', '$id_buku', '$tgl_pinjam', '$tgl_kembali')";
