  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708z"/>
    ...
    <p class="text-center mb-4" style="font-size: 1.1rem;">Temukan berbagai buku menarik di sini!</p>
        ...
        <div class="btn-group mb-3" role="group" aria-label="Kategori Buku">
            <button type="button" class="btn btn-outline-primary" data-genre="fiksi">Fiksi</button>
            <button type="button" class="btn btn-outline-primary" data-genre="non-fiksi">Non-Fiksi</button>
            <button type="button" class="btn btn-outline-primary" data-genre="sejarah">Sejarah</button>
            <button type="button" class="btn btn-outline-primary" data-genre="pelajaran">Pelajaran</button>
        </div>
    ...
    <div class="card h-100 d-flex flex-column" style="border: 1px solid #ddd; border-radius: 5px;">
        <img src="./img/<?php echo $imageFileName; ?>" class="card-img-top" alt="Gambar Buku" style="height: 200px; object-fit: contain;">
        <div class="card-body d-flex flex-column flex-grow-1">
            ...
            <p class="card-text" style="font-size: 0.8rem; color: <?php echo $row['status'] == 'tersedia' ? 'green' : 'red'; ?>;">
                ...
                <div class="modal-body">
                    <form action="proses_ulasan.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ulasan" name="username" rows="3" required></input>
                        </div>
						<div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="rating" class="form-select col-12">
										  <option selected="" value="">Pilih Rating</option>
