    ...
    <tbody>
        ...
        ?>
            <tr align="center">
                ...
                <td class="cell">
                    <img src="./img/<?php echo $imageFileName; ?>" alt="Gambar Buku" style="max-width: 100px;">
                </td>
                ...
                <td class="cell"><?php echo $row['kategori']; ?></td>
                <td class="cell"><?php echo $row['status']; ?></td>
                <td class="cell" align="center">
				<?php
                                          if($row['status'] == 'tersedia'){
                                            echo '<a href="pinjam.php?id_buku=' . $row['id_buku'] . '">';
                                            echo '<button class="btn btn-info" style="color: white" name="pinjam" value="">
                                            Pinjam
                                        </button>';
                                            echo '</a>';
                                          }else  if($row['status'] == 'kosong'){
                                            echo '<a href="kembali.php?id_buku=' . $row['id_buku'] . '">';
                                            echo '<button class="btn btn-warning" style="color: white" name="kembali" value="">
                                            Kembalikan
                                        </button>';
                                            echo '</a>';
                                          }
