    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Form Buku</h1>
			    <hr class="mb-4">
...
if (isset($_POST['submit'])) {
    ...
    $img = $_POST['img']; // URL gambar dari input teks

    // Memproses upload gambar jika ada
    if (isset($_FILES['img_file']) && $_FILES['img_file']['error'] == 0) {
        $target_dir = "img/"; // Direktori penyimpanan gambar
        ...
        // Cek ukuran file
        if ($_FILES["img_file"]["size"] > 5000000) { // Maksimal 5MB
        ...
        if ($uploadOk == 1) {
            if (move_uploaded_file($_FILES["img_file"]["tmp_name"], $target_file)) {
                $img = basename($_FILES["img_file"]["name"]); // Update URL gambar dengan nama file baru
            } else {
