...
// Jumlah Pengguna
$result_pengguna = mysqli_query($koneksi, "SELECT COUNT(*) AS total_pengguna FROM user");
$data_pengguna = mysqli_fetch_assoc($result_pengguna);
$jumlah_pengguna = $data_pengguna['total_pengguna'];

// Jumlah Buku
$result_buku = mysqli_query($koneksi, "SELECT COUNT(*) AS total_buku FROM buku");
$data_buku = mysqli_fetch_assoc($result_buku);
$jumlah_buku = $data_buku['total_buku'];

// Genre Buku
$result_genre = mysqli_query($koneksi, "SELECT kategori, COUNT(*) AS jumlah FROM buku GROUP BY kategori");
$genre_data = [];
		...
		<div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
				    <div class="inner">
					    <div class="app-card-body p-3 p-lg-4">
						    <h3 class="mb-3">Selamat datang, silahkan pinjam buku yang tersedia!</h3>
						    <div class="row gx-5 gy-3">
						        <div class="col-12 col-lg-9">
							        <div>koleksi pribadi, hanya ada satu biji :v</div>
							    </div><!--//col-->
							    <!--//col-->
				...
				<div class="row g-4 mb-4">
				    ...
				    <div class="col-6 col-lg-6">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div class="stats-figure"><p id="jumlahPengguna">0</p></div>
						    </div><!--//app-card-body-->
				    ...
				    <div class="col-6 col-lg-6">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Jumlah Buku</h4>
							    <div class="stats-figure"><p id="jumlahBuku">0</p></div>
						    </div><!--//app-card-body-->
						    <a class="app-card-link-mask" href="#"></a>
					    </div><!--//app-card-->
				    </div><!--//col-->
