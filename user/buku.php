  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708z"/>
    ...
    <div class="app-content pt-3 p-md-3 p-lg-4">
        <div class="container-xl">
            <h1 class="text-center mb-4" style="color:#5d6778">Perpustakaan</h1>
            <p class="text-center mb-4" style="font-size: 1.1rem;">Temukan berbagai buku menarik di sini!</p>

            <div class="mb-3">
                <input type="text" id="search" class="form-control" placeholder="Cari buku...">
            </div>
            
            <div class="btn-group mb-3" role="group" aria-label="Kategori Buku">
                <?php
                    // Mengambil kategori dari tabel kategori_buku
                    $kategori_query = "SELECT * FROM kategori_buku";
                    $kategori_result = mysqli_query($koneksi, $kategori_query);
                    while ($kategori = mysqli_fetch_assoc($kategori_result)) {
                        echo '<button type="button" class="btn btn-outline-primary" onclick="filterByGenre(\'' . $kategori['nama_kategori'] . '\')">' . $kategori['nama_kategori'] . '</button>';
                    }
                ?>
                ...
                <div class="row" id="book-list">
                    <?php
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $genre = $row['nama_kategori']; // Mengambil nama kategori
                    ?>
                        <div class="col-md-2 mb-4 book-item" data-genre="<?= $genre ?>">
                                ...
                                <div class="card-body d-flex flex-column flex-grow-1">
                                    ...
                                    <div class="mt-auto">
                                        <?php if ($row['status'] == 'tersedia'): ?>
                                            <a href="pinjam.php?id_buku=<?php echo $row['id_buku']; ?>" class="w-100">
                                                <button class="btn btn-info w-100" style="color: white">Pinjam</button>
                                            </a>
                                        <?php elseif ($row['status'] == 'kosong'): ?>
                                            <a href="kembali.php?id_buku=<?php echo $row['id_buku']; ?>" class="w-100">
                                                <button class="btn btn-warning w-100" style="color: white">Kembalikan</button>
                                            </a>
                                        <?php endif; ?>
                                    </div>
                                </div>
