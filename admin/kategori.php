					    ...
					    <div class="app-card-body p-4">
						    <div class="row gx-5 gy-3">
						        <div class="col-12 col-lg-9">
							        ...
							        <div>Daftar Kategori yang tersedia.</div>
							    </div><!--//col-->
							    <div class="col-12 col-lg-3">
    <button class="btn app-btn-primary" data-bs-toggle="modal" data-bs-target="#tambahKategoriModal">
...
<div class="tab-content" id="orders-table-tab-content">
    ...
    <thead>
        <tr align="center">
            ...
            <th class="cell">Jumlah Buku</th>
        </tr>
    </thead>
    <tbody id="resultsTableBody">
        <?php
        $query = "SELECT kategori_buku.nama_kategori, COUNT(buku.id_buku) AS jumlah_buku 
                  FROM kategori_buku 
                  LEFT JOIN buku ON kategori_buku.id_kategori = buku.id_kategori 
                  GROUP BY kategori_buku.id_kategori";
        ...
        ?>
            <tr align="center">
                ...
                <td class="cell"><?php echo $row['jumlah_buku']; ?></td>
            </tr>
        <?php
        }
        ?>
...
<div id="customAlert" class="custom-alert">
    <span class="alert-text">Perpustakaan: Kategori Berhasil Ditambahkan!</span>
</div>
